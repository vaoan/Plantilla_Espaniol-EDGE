                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'TextCopy4',
                            type: 'text',
                            rect: ['934px', '333px', '546px', '35px', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\">​¿Con cuál consonante inicia la palabra?</p>",
                        ...
                        {
                            id: 'esn1le01ob04re5au01puerta',
                            display: 'none',
                            type: 'audio',
                            tag: 'audio',
                            rect: ['1072', '287', '320px', '45px', 'auto', 'auto'],
                            source: [aud+"esn1le01ob04re5au01puerta.wav"],
                            preload: 'auto'
                        },
                        {
                            id: 'box_ruleta',
                            ...
                            type: 'rect',
                            rect: ['137', '233px', '515', '515', 'auto', 'auto']
                        }
                    ],
                    style: {
                        '${Stage}': {
