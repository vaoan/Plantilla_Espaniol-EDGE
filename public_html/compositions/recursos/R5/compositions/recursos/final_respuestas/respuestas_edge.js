                    ...
                    dom: [
                        {
                            id: 'conburro',
                            type: 'rect',
                            rect: ['452px', '136px', '240px', '240px', 'auto', 'auto'],
                            overflow: 'hidden',
                        ...
                        },
                        {
                            id: 'contmesa',
                            type: 'rect',
                            rect: ['779px', '136px', '240px', '240px', 'auto', 'auto'],
                            overflow: 'hidden',
                            borderRadius: ["10px", "10px", "10px", "10px"],
                            fill: ["rgba(192,192,192,0.00)"],
                            stroke: [5,"rgba(79,45,110,1.00)","solid"],
                        ...
                        },
                        {
                            id: 'contuva',
                            type: 'rect',
                            rect: ['1106px', '136px', '240px', '240px', 'auto', 'auto'],
                            overflow: 'hidden',
                            borderRadius: ["10px", "10px", "10px", "10px"],
                            fill: ["rgba(192,192,192,0.00)"],
                            stroke: [5,"rgba(79,45,110,1.00)","solid"],
                        ...
                        },
                        {
                            id: 'RectangleCopy4',
                            type: 'rect',
                            rect: ['452px', '346px', '250px', '40px', 'auto', 'auto'],
                        ...
                        },
                        {
                            id: 'RectangleCopy',
                            type: 'rect',
                            rect: ['779px', '346px', '250px', '40px', 'auto', 'auto'],
                            borderRadius: ["0px", "0px", "18px 18px", "18px 18px"],
                            fill: ["rgba(79,45,110,1.00)"],
                            stroke: [0,"rgba(0,0,0,1)","none"]
                        },
                        {
                            id: 'Rectangle',
                            type: 'rect',
                            rect: ['1106px', '346px', '250px', '40px', 'auto', 'auto'],
                            borderRadius: ["0px", "0px", "18px 18px", "18px 18px"],
                            fill: ["rgba(79,45,110,1.00)"],
                            stroke: [0,"rgba(0,0,0,1)","none"]
                        },
                        {
                            id: 'texto_5',
                            type: 'text',
                            rect: ['495px', '339px', '165px', '40px', 'auto', 'auto'],
                        ...
                        },
                        {
                            id: 'texto_4',
                            type: 'text',
                            rect: ['822px', '339px', '165px', '40px', 'auto', 'auto'],
                        ...
                        },
                        {
                            id: 'texto_3',
                            type: 'text',
                            rect: ['1149px', '339px', '165px', '40px', 'auto', 'auto'],
                        ...
                        },
                        {
                            ...
                            symbolName: 'lupa',
                            type: 'rect',
                            rect: ['452px', '136px', '46', '46', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'lupa_2',
                            symbolName: 'lupa',
                            type: 'rect',
                            rect: ['779px', '136px', '46', '46', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'lupa_3',
                            symbolName: 'lupa',
                            type: 'rect',
                            rect: ['1106px', '136px', '46', '46', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'Text',
                            type: 'text',
                            rect: ['237px', '46px', 'auto', 'auto', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\">​<span style=\"font-family: source-sans-pro, sans-serif; font-size: 54px; font-weight: 600;\">Ha agotado sus intentos. Observe las respuestas correctas.</span></p>",
                            font: ['Arial, Helvetica, sans-serif', [24, ""], "rgba(51,51,51,1.00)", "normal", "none", "", "break-word", "nowrap"]
                        },
                        {
                            id: 'lupa_4',
                            symbolName: 'lupa',
