        ...
        symbols = {
                    ...
                    dom: [
                        {
                            ...
                            },
                            {
                                ...
                                text: "<p style=\"margin:0px\">​<span style=\"color: rgb(51, 51, 51);\">Faro</span></p><p style=\"margin: 0px;\"><span style=\"color: rgb(51, 51, 51);\">​Dedo</span></p><p style=\"margin: 0px;\"><span style=\"color: rgb(51, 51, 51);\">Mesa</span></p><p style=\"margin: 0px;\"><span style=\"color: rgb(51, 51, 51);\">​Burro</span></p>",
                                align: "left",
                            ...
                            },
                            {
                                ...
                                symbolName: 'lupa',
                                type: 'rect',
                                rect: ['635px', '311px', '46', '46', 'auto', 'auto'],
                                cursor: 'pointer'
                            }]
                        },
                        {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            preload: 'auto',
                            type: 'audio',
                            source: ['media/dedoesn1le01ob01re5au05.mp3'],
                            id: 'audiomp3_1',
                            rect: ['595', '-77', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                        }
                    ],
            ...
            "zoom": {
                ...
                content: {
                    dom: [
                        {
                            rect: ['-400px', '-39px', '1830px', '780px', 'auto', 'auto'],
                        ...
                        {
                            rect: ['212px', '48px', '600px', '600px', 'auto', 'auto'],
                            borderRadius: ['10px', '10px', '10px', '10px'],
                            overflow: 'hidden',
                            id: 'Zoom',
                            ...
                            c: [
                            {
                                rect: ['-2px', '-2px', '605px', '605px', 'auto', 'auto'],
                                id: 'dedo2',
                        ...
                        },
                        {
                            ...
                            cursor: 'pointer',
                            rect: ['769px', '605px', null, null, 'auto', 'auto']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
