                    ...
                    dom: [
                        {
                            ...
                            },
                            {
                                ...
                                symbolName: 'audio_1',
                                type: 'rect',
                                rect: ['737px', '195px', '70', '40', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'texto_2',
                                type: 'text',
                                rect: ['946px', '91px', '209px', '201px', 'auto', 'auto'],
                                text: "<p style=\"margin:0px\">​<span style=\"color: rgb(51, 51, 51);\">Árbol</span></p><p style=\"margin: 0px;\"><span style=\"color: rgb(51, 51, 51);\">Faro</span></p><p style=\"margin: 0px;\"><span style=\"color: rgb(51, 51, 51);\">​Dedo</span></p><p style=\"margin: 0px;\"><span style=\"color: rgb(51, 51, 51);\">​Uva</span></p>",
                                align: "left",
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            preload: 'auto',
                            type: 'audio',
                            source: ['media/uvaesn1le01ob01re5au03.mp3'],
                            id: 'audiomp3_1',
                            rect: ['170', '26', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                        }
                    ],
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            [ "eid263", "trigger", 125, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${audiomp3_1}', [] ] ]
                    ]
                }
            },
            "PICK_4": {
