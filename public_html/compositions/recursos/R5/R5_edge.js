                    ...
                    dom: [
                        {
                            ...
                            c: [
                            {
                                ...
                                c: [
                                {
                                    id: 'correcto',
                                    type: 'image',
                                    rect: ['105px', '25px', '150px', '150px', 'auto', 'auto'],
                                    fill: ["rgba(0,0,0,0)",im+"correcto.png",'0px','0px']
                                },
                                {
                                    id: 'texto_5',
                                    type: 'text',
                                    rect: ['0px', '201px', '360px', '43px', 'auto', 'auto'],
                                    overflow: 'visible',
                        ...
                        },
                        {
                            ...
                            },
                            {
                                ...
                                text: "<p style=\"margin: 0px; line-height: 38px;\">​¡Respuesta incorrecta!</p>",
                                align: "center",
                                font: ['source-sans-pro, sans-serif', [32, "px"], "rgba(0,0,0,1)", "600", "none", "", "break-word", ""]
                            },
                            {
                        ...
                        },
                        {
                            ...
                            clip: 'rect(0px 193.8662109375px 48.3447265625px -28.8662109375px)',
                            cursor: 'pointer'
                        },
                        {
                            id: 'precarga_gif',
            ...
            "R6_portada": {
                ...
                content: {
                    dom: [
                        ...
                        {
                            rect: ['748px', '362px', '335px', '55px', 'auto', 'auto'],
            ...
            "Submit": {
                ...
                content: {
                    ...
                    style: {
                        '${symbolSelector}': {
                            isStage: 'true',
                            rect: [undefined, undefined, '243px', '56px']
                        }
                    }
                },
                timeline: {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            align: 'center',
                            rect: ['-18px', '38px', '136px', '26px', 'auto', 'auto']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
