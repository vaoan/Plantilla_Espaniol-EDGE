...
(function ($, Edge, compId) {
    ...
    (function (symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 6223, function(sym, e) {
         sym.stop();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${Btn_Respuestascorrecto}", "click", function(sym, e) {
         // introducir aquí código para clic de ratón
   ...
   //Edge symbol end:'Btn_Respuestas'
