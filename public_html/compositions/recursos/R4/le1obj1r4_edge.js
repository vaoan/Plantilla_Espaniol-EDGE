                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'Text2',
                            type: 'text',
                            rect: ['51px', '146px', '1763px', '30px', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\">​<span style=\"font-size: 28px;\">Las letras que se usan para formar palabras dependen de la ortografía,  conjunto de normas que definen cómo se escriben las palabras.</span></p><p style=\"margin: 0px;\">​</p>",
                            align: "left",
                        ...
                        },
                        {
                            id: 'Text2Copy',
                            type: 'text',
                            rect: ['49px', '192px', '1763px', '30px', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\">​<span style=\"font-size: 28px;\">Instrucción: haga clic en cada uno de los botones para observar las imágenes.  Escuche el audio y luego relacione los nombres de la lista desplegable con la letra de la columna. Tiene dos intentos para esta actividad.</span></p><p style=\"margin: 0px;\">​</p>",
                            align: "left",
                        ...
                        },
                        {
                            id: 'Text2Copy2',
                            type: 'text',
                            rect: ['53px', '57px', '1763px', '30px', 'auto', 'auto'],
                        ...
                        },
                        {
                            ...
                            type: 'image',
                            rect: ['24px', '158px', '18px', '18px', 'auto', 'auto'],
                        ...
                        },
                        {
                            ...
                            symbolName: 'DRAG_1',
                            type: 'rect',
                            rect: ['1612px', '413px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'DRAG_2',
                            symbolName: 'DRAG_2',
                            type: 'rect',
                            rect: ['1612px', '615px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'DRAG_3',
                            symbolName: 'DRAG_3',
                            type: 'rect',
                            rect: ['1612px', '550px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'DRAG_4',
                            symbolName: 'DRAG_4',
                            type: 'rect',
                            rect: ['1612px', '343px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'DRAG_5',
                            symbolName: 'DRAG_5',
                            type: 'rect',
                            rect: ['1612px', '478px', 'undefined', 'undefined', 'auto', 'auto'],
                            cursor: 'pointer'
                        }
                    ],
                    style: {
