...
(function (compId) {
                    ...
                    dom: [
                        {
                            id: 'cont_1',
                            type: 'rect',
                            rect: ['0px', '255px', '1830px', '525px', 'auto', 'auto'],
                            ...
                            c: [
                            {
                                id: 'texto_3',
                                type: 'text',
                                rect: ['758px', '15px', '441px', '160px', 'auto', 'auto'],
                                text: "<p style=\"margin: 0px;\">​<span style=\"font-size: 30px; color: rgb(51, 51, 51);\">t</span></p><p style=\"margin: 0px;\">​c</p><p style=\"margin: 0px;\">​b</p><p style=\"margin: 0px;\">​d&nbsp;</p><p style=\"margin: 0px;\">​</p><p style=\"margin:0px\">​</p>",
                                align: "left",
                            ...
                            },
                            {
                                ...
                                type: 'rect',
                                rect: ['296px', '18px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer',
                            ...
                            },
                            {
                                ...
                                symbolName: 'PICK_1',
                                type: 'rect',
                                rect: ['727px', '28px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'PICK_2',
                                symbolName: 'PICK_2',
                                type: 'rect',
                                rect: ['727px', '70px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'PICK_3',
                                symbolName: 'PICK_3',
                                type: 'rect',
                                rect: ['727px', '108px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'PICK_4',
                                symbolName: 'PICK_4',
                                type: 'rect',
                                rect: ['727px', '148px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            }]
                        },
                        {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            id: 'r6_audio_1',
                            rect: ['637', '449', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                        }
                    ],
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            [ "eid172", "trigger", 124, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${r6_audio_1}', [] ] ]
                    ]
                }
            },
            "margen_inferior": {
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("esn1le01ob01r6pre3_edgeActions.js");
})("EDGE-17298671");
