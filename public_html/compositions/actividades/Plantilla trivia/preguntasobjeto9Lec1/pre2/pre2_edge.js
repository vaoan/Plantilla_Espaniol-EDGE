                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'RoundRect2Copy',
                            type: 'rect',
                            rect: ['853px', '386px', '376px', '239px', 'auto', 'auto'],
                            borderRadius: ["10px", "10px", "10px", "10px"],
                        ...
                        },
                        {
                            ...
                            c: [
                            {
                                ...
                                fill: ["rgba(0,0,0,0)",im+"unas.png",'0px','0px'],
                                transform: [[],[],[],['1.05','1.05']]
                            }]
                        },
                        {
                        ...
                        },
                        {
                            id: 'Text2Copy4',
                            type: 'text',
                            rect: ['946px', '406px', '283px', '201px', 'auto', 'auto'],
                            text: "<p style=\"margin:0px\">​un</p><p style=\"margin:0px\">​una</p><p style=\"margin:0px\">​unos</p><p style=\"margin:0px\">​unas</p>",
                            align: "left",
