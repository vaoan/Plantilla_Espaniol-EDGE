                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'RoundRect2Copy',
                            type: 'rect',
                            rect: ['853px', '356px', '376px', '239px', 'auto', 'auto'],
                            borderRadius: ["10px", "10px", "10px", "10px"],
                        ...
                        },
                        {
                            ...
                            c: [
                            {
                                id: 'hombremujer',
                                type: 'image',
                                rect: ['-11px', '1px', '300px', '280px', 'auto', 'auto'],
                                fill: ["rgba(0,0,0,0)",im+"hombremujer.png",'0px','0px'],
                                transform: [[],[],[],['1.05','1.05']]
                            }]
                        },
                        {
                        ...
                        },
                        {
                            id: 'Text2Copy4',
                            type: 'text',
                            rect: ['946px', '376px', '283px', '201px', 'auto', 'auto'],
                            text: "<p style=\"margin:0px\">​ombre /mujer</p><p style=\"margin: 0px;\">​hombre / hombra</p><p style=\"margin: 0px;\">​hombre / mujer</p><p style=\"margin: 0px;\">​hembra /mujer</p>",
                            align: "left",
