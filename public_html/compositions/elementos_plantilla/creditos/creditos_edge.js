                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'RoundRect3',
                            type: 'rect',
                            rect: ['193px', 'auto', '1550px', '34px', 'auto', '115px'],
                            borderRadius: ["0px 0px", "0px 0px", "15px 15px", "15px 15px"],
