                    ...
                    dom: [
                        {
                            ...
                            c: [
                            {
                                ...
                                symbolName: 'PICK_1',
                                type: 'rect',
                                rect: ['435px', '75px', '199', '250', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'Skills',
                            ...
                            },
                            {
                                ...
                                symbolName: 'PICK_3',
                                type: 'rect',
                                rect: ['1190px', '75px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            }]
                        }
                    ],
                    ...
                    dom: [
                        {
                            ...
                            id: 'este_lapiz2',
                            type: 'image',
                            rect: ['-50px', '14px', '297px', '294px', 'auto', 'auto'],
                            fill: ['rgba(0,0,0,0)', 'images/este_lapiz.png', '0px', '0px']
                        },
                        {
                    ...
                    dom: [
                        {
                            ...
                            id: 'aquel_lapiz3',
                            type: 'image',
                            rect: ['-50px', '12px', '294px', '297px', 'auto', 'auto'],
                            fill: ['rgba(0,0,0,0)', 'images/aquel_lapiz.png', '0px', '0px']
                        },
                        {
                    ...
                    dom: [
                        ...
                        },
                        {
                            ...
                            c: [
                            {
                                ...
                                textShadow: ['rgba(0,0,0,0.65098)', 1, 1, 1],
                                rect: ['200px', '1px', '234px', '31px', 'auto', 'auto']
                            }]
                        },
                        {
                            type: 'rect',
