                    ...
                    dom: [
                        {
                            ...
                            },
                            {
                                id: 'texto_2',
                                type: 'text',
                                rect: ['472px', '132px', '577px', '40px', 'auto', 'auto'],
                                text: "<p style=\"margin: 0px; line-height: 34px;\">​¿Cuál es la última consonante de la palabra?</p><p style=\"margin: 0px;\">​</p><p style=\"margin: 0px;\">​</p><p style=\"margin: 0px; line-height: 34px;\"><span style=\"font-size: 30px;\">​</span></p>",
                                align: "left",
                            ...
                            },
                            {
                                ...
                                c: [
                                {
                                    id: 'texto_3',
                                    type: 'text',
                                    rect: ['-31px', '0px', '113px', '50px', 'auto', 'auto'],
