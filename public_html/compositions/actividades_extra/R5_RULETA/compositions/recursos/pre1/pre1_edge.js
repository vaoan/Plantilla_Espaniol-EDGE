                    ...
                    dom: [
                        {
                            ...
                            c: [
                            {
                                id: 'fondo',
                                type: 'rect',
                                rect: ['282px', '92px', '1286px', '140px', 'auto', 'auto'],
                            ...
                            },
                            {
                                ...
                                symbolName: 'text_1',
                                type: 'rect',
                                rect: ['1066px', '135px', '442', '57', 'auto', 'auto']
                            },
                            {
                                id: 'texto_2',
                                type: 'text',
                                rect: ['449px', '138px', '572px', '40px', 'auto', 'auto'],
                                text: "<p style=\"margin: 0px; line-height: 34px;\">​¿Cuál es la primera consonante de la palabra?   &nbsp;</p>",
                                align: "left",
                            ...
                            },
                            {
                                ...
                                symbolName: 'audio_1',
                                type: 'rect',
                                rect: ['354px', '144px', '70', '40', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'Numero1',
                                type: 'ellipse',
                                rect: ['257px', '67px', '50px', '50px', 'auto', 'auto'],
                            ...
                            },
                            {
                                ...
                                symbolName: 'Skills',
                                type: 'rect',
                                rect: ['0px', '343px', '283', '157', 'auto', 'auto']
                            }]
                        },
                        {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            preload: 'auto',
                            type: 'audio',
                            source: ['media/puertaesn1le01ob04re5au01.mp3'],
                            id: 'audiomp3_1',
                            rect: ['517', '-76', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                        }
                    ],
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            [ "eid2", "trigger", 125, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${audiomp3_1}', [] ] ]
                    ]
                }
            },
            "oral": {
