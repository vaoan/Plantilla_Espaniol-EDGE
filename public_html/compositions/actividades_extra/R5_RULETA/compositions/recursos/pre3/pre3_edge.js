                    ...
                    dom: [
                        {
                            ...
                            },
                            {
                                id: 'contextoCopy',
                                type: 'text',
                                rect: ['461px', '140px', '623px', '40px', 'auto', 'auto'],
                                text: "<p style=\"margin: 0px; line-height: 34px;\">​¿Cuál es la primera consonante de la palabra?​</p><p style=\"margin: 0px;\">​</p><p style=\"margin: 0px; line-height: 34px;\"><span style=\"font-size: 30px;\">​</span></p>",
                                align: "left",
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            preload: 'auto',
                            type: 'audio',
                            source: ['media/escaleraesn1le01ob04re5au03.mp3'],
                            id: 'audiomp3_1',
                            rect: ['70', '-52', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                        }
                    ],
