                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            id: 'Text2',
                            text: '<p style=\"margin: 0px;\">​a. Caña</p>',
                            align: 'center',
                            type: 'text'
                        }
                    ],
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            font: ['source-sans-pro, sans-serif', [36, 'px'], 'rgba(255,255,255,1.00)', '400', 'none', 'normal', 'break-word', ''],
                            id: 'Text2',
                            text: '<p style=\"margin: 0px;\">​b. Cana</p>',
                            align: 'center',
                            type: 'text'
                        }
                    ],
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            font: ['source-sans-pro, sans-serif', [36, 'px'], 'rgba(255,255,255,1.00)', '400', 'none', 'normal', 'break-word', ''],
                            id: 'Text2',
                            text: '<p style=\"margin: 0px;\">​c. Cama</p>',
                            align: 'center',
                            type: 'text'
                        }
                    ],
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            font: ['source-sans-pro, sans-serif', [36, 'px'], 'rgba(255,255,255,1.00)', '400', 'none', 'normal', 'break-word', ''],
                            id: 'Text2',
                            text: '<p style=\"margin: 0px;\">​d. Cada</p>',
                            align: 'center',
                            type: 'text'
                        }
                    ],
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            type: 'text',
                            id: 'Text',
                            text: '<p style=\"margin: 0px;\">​La palabra correcta contiene la letra <span style=\"font-weight: 700;\">m</span></p>',
                            align: 'center',
            ...
            "publico": {
                ...
                content: {
                    dom: [
                        ...
                        {
                            rect: ['228px', '176px', '13px', '232px', 'auto', 'auto'],
                            id: 'Rectangle3Copy5',
                            stroke: [0, 'rgb(0, 0, 0)', 'none'],
                            type: 'rect',
                            fill: ['rgba(253,253,254,1.00)']
