                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: '<p style=\"margin: 0px;\">​a. Galón</p>',
                            id: 'texto_2',
                            textStyle: ['', '', '', '', 'none'],
                            align: 'center',
            ...
            "PICK_2": {
                ...
                content: {
                    dom: [
                        ...
                        {
                            type: 'text',
                            rect: ['40px', '-2px', '323px', '52px', 'auto', 'auto'],
                            text: '<p style=\"margin: 0px;\">​b. Cajón</p>',
                            id: 'texto_4',
                            textStyle: ['', '', '', '', 'none'],
                            align: 'center',
                            font: ['source-sans-pro, sans-serif', [36, 'px'], 'rgba(255,255,255,1.00)', '400', 'none', 'normal', 'break-word', '']
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            type: 'text',
                            rect: ['40px', '-2px', '323px', '52px', 'auto', 'auto'],
                            text: '<p style=\"margin: 0px;\">​c. Avión</p>',
                            id: 'texto_3',
                            textStyle: ['', '', '', '', 'none'],
                            align: 'center',
                            font: ['source-sans-pro, sans-serif', [36, 'px'], 'rgba(255,255,255,1.00)', '400', 'none', 'normal', 'break-word', '']
            ...
            "PICK_4": {
                ...
                content: {
                    dom: [
                        ...
                        {
                            type: 'text',
                            rect: ['0px', '-2px', '401px', '52px', 'auto', 'auto'],
                            text: '<p style=\"margin: 0px;\">​d. Caja</p>',
                            id: 'texto_5',
                            textStyle: ['', '', '', '', 'none'],
                            align: 'center',
                            font: ['source-sans-pro, sans-serif', [36, 'px'], 'rgba(255,255,255,1.00)', '400', 'none', 'normal', 'break-word', '']
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            type: 'text',
                            id: 'Text',
                            text: '<p style=\"margin: 0px;\">​La palabra correcta contiene la letra <span style=\"font-weight: 700;\">j</span></p>',
                            align: 'center',
            ...
            "publico": {
                ...
                content: {
                    dom: [
                        ...
                        {
                            rect: ['83px', '300px', '13px', '108px', 'auto', 'auto'],
                            id: 'Rectangle3Copy7',
                            stroke: [0, 'rgb(0, 0, 0)', 'none'],
                            type: 'rect',
                        ...
                        {
                            rect: ['155px', '193px', '13px', '215px', 'auto', 'auto'],
                            id: 'Rectangle3Copy6',
                            stroke: [0, 'rgb(0, 0, 0)', 'none'],
                            type: 'rect',
                            fill: ['rgba(253,253,254,1.00)']
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            id: 'audiomp3_1',
                            rect: ['1151', '473', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                        }
                    ],
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            [ "eid91", "trigger", 124, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${audiomp3_1}', [] ] ]
                    ]
                }
            }
        };
