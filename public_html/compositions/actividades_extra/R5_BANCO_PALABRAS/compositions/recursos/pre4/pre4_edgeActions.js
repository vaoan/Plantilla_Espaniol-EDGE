...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // los alias más comunes para las clases de Edge
   ...
   //Edge symbol end:'oral_1'

   //=========================================================
   
   //Edge symbol: 'auditiva_1'
   (function(symbolName) {   
   ...
   //Edge symbol end:'lectora_1'

   //=========================================================
   
   //Edge symbol: 'escrita_1'
   (function(symbolName) {   
