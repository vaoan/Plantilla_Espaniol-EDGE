        ...
        symbols = {
                    ...
                    dom: [
                        ...
                        },
                        {
                            ...
                            },
                            {
                                id: 'texto_4',
                                type: 'text',
                                rect: ['611px', '154px', '132px', '30px', 'auto', 'auto'],
                            ...
                            },
                            {
                                id: 'texto_4Copy',
                                type: 'text',
                                rect: ['1109px', '151px', '132px', '30px', 'auto', 'auto'],
                            ...
                            },
                            {
                                ...
                                symbolName: 'DRAG_1',
                                type: 'rect',
                                rect: ['950px', '228px', '185', '48', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'DRAG_2',
                                symbolName: 'DRAG_2',
                                type: 'rect',
                                rect: ['714px', '228px', '185', '48', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'audio_1',
            ...
            "DRAG_2": {
                ...
                content: {
                    dom: [
                        {
                            rect: ['7px', '0px', '158px', '34px', 'auto', 'auto'],
                            borderRadius: ['10px', '10px', '10px', '10px'],
                            transform: [[], [], [], ['1.08', '1.08']],
                            id: 'RoundRect11',
                            stroke: [7, 'rgb(139, 116, 161)', 'solid'],
                            ...
                            c: [
                            {
                                rect: ['-10px', '1px', '171px', '32px', 'auto', 'auto'],
                                textStyle: ['', '', '', '', 'none'],
                                font: ['source-sans-pro, sans-serif', [20, 'px'], 'rgba(0,0,0,1)', '400', 'none', 'italic', 'break-word', ''],
                                id: 'texto_5',
                                text: '<p style=\"margin: 0px; line-height: 20px;\">​<span style=\"font-size: 30px; color: rgb(255, 255, 255); font-style: normal;\">son</span></p>',
                                align: 'center',
                                type: 'text'
                            }]
                        }
