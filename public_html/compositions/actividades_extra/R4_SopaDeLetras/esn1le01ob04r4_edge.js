                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            symbolName: 'Skills',
                            type: 'rect',
                            rect: ['17px', '617px', '283', '157', 'auto', 'auto']
                        },
                        {
                            id: 'audio_5',
                            symbolName: 'audio_5',
            ...
            "SOPA": {
                ...
                content: {
                    ...
                    style: {
                        '${symbolSelector}': {
                            isStage: 'true',
                            rect: [undefined, undefined, '740px', '520px']
                        }
                    }
                },
                timeline: {
                    ...
                    dom: [
                        {
                            ...
                            fill: ['rgba(0,0,0,0)', 'images/sopadeletras-102.png', '0px', '0px'],
                            type: 'image',
                        ...
                        },
                        {
                            ...
                            fill: ['rgba(0,0,0,0)', 'images/sopadeletras-092.png', '0px', '0px'],
                            id: 'sopadeletras-09Copy',
                            opacity: '1',
                            type: 'image',
                            tag: 'img'
                        },
