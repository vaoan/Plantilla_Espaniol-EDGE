...
(function (compId) {
                    ...
                    dom: [
                        {
                            id: 'texto_1',
                            type: 'text',
                            rect: ['666px', '413px', '170px', '40px', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\"><span style=\"font-size: 30px; color: rgb(51, 51, 51);\">Hospital.</span></p>",
                            align: "left",
                        ...
                        },
                        {
                            id: 'texto_2',
                            type: 'text',
                            rect: ['948px', '413px', '441px', '40px', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\"><span style=\"font-size: 30px; color: rgb(51, 51, 51);\">Hospitales.</span></p>",
                            align: "left",
                            font: ['source-sans-pro, sans-serif', [28, "px"], "rgba(0,0,0,1)", "400", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "40px", "", "none"]
                        },
                        {
                            ...
                            c: [
                            {
                                ...
                                type: 'image',
                                tag: 'img',
                                rect: ['-5px', '-5px', '250px', '233px', 'auto', 'auto'],
                        ...
                        },
                        {
                            ...
                            symbolName: 'audio_1',
                            type: 'rect',
                            rect: ['245px', '485px', '70', '40', 'auto', 'auto'],
                            cursor: 'pointer',
                            transform: [[],['-1']]
                        },
                        {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            id: 'audiomp3_1',
                            rect: ['913', '454', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                        }
                    ],
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            [ "eid198", "trigger", 125, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${audiomp3_1}', [] ] ]
                    ]
                }
            },
            "PICK_2": {
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("preg_5_edgeActions.js");
})("EDGE-17298671");
