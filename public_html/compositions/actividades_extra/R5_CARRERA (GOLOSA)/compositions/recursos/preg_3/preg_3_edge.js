...
(function (compId) {
                    ...
                    dom: [
                        {
                            ...
                            text: "<p style=\"margin: 0px;\"><span style=\"font-size: 30px; color: rgb(51, 51, 51);\">Iglesia.</span></p>",
                            align: "left",
                        ...
                        },
                        {
                            ...
                            text: "<p style=\"margin: 0px;\"><span style=\"font-size: 30px; color: rgb(51, 51, 51);\">Iglesias.</span></p>",
                            align: "left",
                            font: ['source-sans-pro, sans-serif', [28, "px"], "rgba(51,51,51,1.00)", "400", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "40px", "", "none"]
                        },
                        {
                            ...
                            type: 'rect',
                            rect: ['233px', '324px', '240px', '195px', 'auto', 'auto'],
                            overflow: 'hidden',
                            ...
                            c: [
                            {
                                ...
                                type: 'image',
                                tag: 'img',
                                rect: ['-5px', '-5px', '250px', '205px', 'auto', 'auto'],
                        ...
                        },
                        {
                            ...
                            symbolName: 'audio_1',
                            type: 'rect',
                            rect: ['245px', '476px', '70', '40', 'auto', 'auto'],
                            cursor: 'pointer',
                            transform: [[],['-1']]
                        },
                        {
                        ...
                        },
                        {
                            ...
                            symbolName: 'lupa_1',
                            type: 'rect',
                            rect: ['432px', '478px', '46', '46', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'zoom_1',
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            id: 'audiomp3_1',
                            rect: ['1199', '351', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                        }
                    ],
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("preg_3_edgeActions.js");
})("EDGE-17298671");
