...
(function (compId) {
                    ...
                    dom: [
                        {
                            ...
                            text: "<p style=\"margin: 0px;\"><span style=\"font-size: 30px; color: rgb(51, 51, 51);\">Camino.</span></p>",
                            align: "left",
                        ...
                        },
                        {
                            ...
                            text: "<p style=\"margin: 0px;\"><span style=\"color: rgb(51, 51, 51); font-size: 30px;\">Caminos.</span></p>",
                            align: "left",
                            font: ['source-sans-pro, sans-serif', [28, "px"], "rgba(51,51,51,1.00)", "400", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "40px", "", "none"]
                        },
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            id: 'audiomp3_1',
                            rect: ['1579', '386', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                        }
                    ],
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("preg_4_edgeActions.js");
})("EDGE-17298671");
