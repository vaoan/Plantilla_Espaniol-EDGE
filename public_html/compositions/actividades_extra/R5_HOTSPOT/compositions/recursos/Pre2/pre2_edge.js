                    ...
                    dom: [
                        {
                            id: 'cont_1',
                            type: 'rect',
                            rect: ['0px', '310px', '1830px', '470px', 'auto', 'auto'],
                            ...
                            c: [
                            {
                                ...
                                type: 'image',
                                tag: 'img',
                                rect: ['1078px', '48px', '300px', '280px', 'auto', 'auto'],
                                borderRadius: ["32px", "32px", "32px", "32px 32px"],
                                fill: ["rgba(0,0,0,0)",im+"gordo.png",'0px','0px'],
                                transform: [[],[],[],['1.19','1.19']]
                            },
                            {
                                id: 'Skills',
                                symbolName: 'Skills',
                                type: 'rect',
                                rect: ['14px', '306px', '283', '157', 'auto', 'auto'],
                                overflow: 'hidden'
                            },
                            {
                                id: 'audio_1',
                                symbolName: 'audio_1',
                                type: 'rect',
                                rect: ['451px', '157px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'PICK_1',
                                symbolName: 'PICK_1',
                                type: 'rect',
                                rect: ['1130px', '40px', '253', '279', 'auto', 'auto'],
                                cursor: 'pointer'
                            }]
                        },
                        {
                    ...
                    dom: [
                        {
                            ...
                            c: [
                            {
                                rect: ['190px', '1px', '163px', '31px', 'auto', 'auto'],
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            [ "eid191", "trigger", 124, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${audio_r6_1}', [] ] ]
                    ]
                }
            },
            "PICK_1": {
