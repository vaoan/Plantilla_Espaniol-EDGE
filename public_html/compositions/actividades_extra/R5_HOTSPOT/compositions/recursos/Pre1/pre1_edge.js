                    ...
                    dom: [
                        {
                            ...
                            type: 'text',
                            rect: ['137px', '61px', '1563px', '205px', 'auto', 'auto'],
                        ...
                        },
                        {
                            id: 'cont_1',
                            type: 'rect',
                            rect: ['0px', '297px', '1828px', '481px', 'auto', 'auto'],
                            ...
                            c: [
                            {
                                ...
                                type: 'image',
                                tag: 'img',
                                rect: ['917px', '90px', '300px', '280px', 'auto', 'auto'],
                                borderRadius: ["32px", "32px", "32px", "32px 32px"],
                                fill: ["rgba(0,0,0,0)",im+"kiwi.png",'0px','0px'],
                                transform: [[],[],[],['1.19','1.19']]
                            },
                            {
                                id: 'audio_1',
                                symbolName: 'audio_1',
                                type: 'rect',
                                rect: ['397px', '139px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'PICK_1',
                                symbolName: 'PICK_1',
                                type: 'rect',
                                rect: ['1028px', '82px', '199', '250', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'Skills',
                                symbolName: 'Skills',
                                type: 'rect',
                                rect: ['13px', '318px', '283', '157', 'auto', 'auto'],
                                overflow: 'hidden'
                            }]
                        }
                    ],
                    ...
                    dom: [
                        {
                            ...
                            c: [
                            {
                                rect: ['190px', '1px', '180px', '31px', 'auto', 'auto'],
                        ...
                        },
                        {
                            ...
                            id: 'audio_r6_1',
                            rect: ['449', '358', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                        }
                    ],
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            [ "eid182", "trigger", 124, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${audio_r6_1}', [] ] ]
                    ]
                }
            }
        };
