                    ...
                    dom: [
                        ...
                        },
                        {
                            ...
                            },
                            {
                                ...
                                symbolName: 'audio_1',
                                type: 'rect',
                                rect: ['412px', '165px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'gotas',
                                type: 'image',
                                tag: 'img',
                                rect: ['1030px', '67px', '300px', '280px', 'auto', 'auto'],
                                borderRadius: ["32px", "32px", "32px", "32px 32px"],
                                fill: ["rgba(0,0,0,0)",im+"gotas.png",'0px','0px'],
                                transform: [[],[],[],['1.19','1.19']]
                            },
                            {
                                id: 'PICK_1',
                                symbolName: 'PICK_1',
                                type: 'rect',
                                rect: ['1064px', '62px', '253', '279', 'auto', 'auto'],
                                cursor: 'pointer'
                            }]
                        }
                    ],
