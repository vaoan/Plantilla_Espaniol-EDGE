                    ...
                    dom: [
                        {
                            ...
                            type: 'text',
                            rect: ['137px', '65px', '1563px', '205px', 'auto', 'auto'],
                        ...
                        },
                        {
                            id: 'cont_1',
                            type: 'rect',
                            rect: ['0px', '298px', '1830px', '482px', 'auto', 'auto'],
                            ...
                            c: [
                            {
                                ...
                                type: 'image',
                                tag: 'img',
                                rect: ['1022px', '75px', '300px', '280px', 'auto', 'auto'],
                            ...
                            },
                            {
                                ...
                                symbolName: 'PICK_1',
                                type: 'rect',
                                rect: ['1052px', '43px', '253', '279', 'auto', 'auto'],
                                cursor: 'pointer'
                            },
                            {
                                id: 'Skills',
                                symbolName: 'Skills',
                                type: 'rect',
                                rect: ['14px', '318px', '283', '157', 'auto', 'auto'],
                                overflow: 'hidden'
                            },
                            {
                                id: 'audio_1',
                                symbolName: 'audio_1',
                                type: 'rect',
                                rect: ['437px', '168px', 'undefined', 'undefined', 'auto', 'auto'],
                                cursor: 'pointer'
                            }]
                        }
                    ],
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            id: 'audio_r6_1',
                            rect: ['451', '239', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                        }
                    ],
