...
****************************************************************************/
/*******************************************************************************
** Usage: Executable course content can call the Wrapper
...
** Inputs:  intId - the id of the interaction
** Return:  the index where this interaction is located 
**
** Description:
**
*******************************************************************************/
function findInteraction(intId) 
{
    ...
    for (var i=0; i < num; ++i) {
        if (doGetValue("cmi.interactions." + i + ".id") == intId) {
            intIndex = i;
            break;
        }
    }
